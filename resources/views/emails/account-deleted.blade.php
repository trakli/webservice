@extends('emails.layouts.base', [
    'title' => 'Your Trakli account has been deleted',
    'preheader' => 'Confirmation that your account and all associated data have been removed.',
])
...
@section('content')
    ...
    <p style="margin:0 0 16px; font-size:15px; line-height:1.65;">
        Your Trakli account and all associated data have been permanently deleted. This includes your wallets, transactions, categories, groups, files, and configuration.
    </p>

    <p style="margin:0 0 16px; font-size:15px; line-height:1.65;">
        If you didn't request this, please contact us right away at
        <a href="mailto:support@trakli.app" style="color:#047844; text-decoration:none;">support@trakli.app</a>.
