...
@section('content')
    ...
    <p style="margin:0 0 8px; font-size:12px; color:#6b7280; text-transform:uppercase; letter-spacing:0.5px; font-weight:500;">
        {{ $daysInactive }} days since your last transaction
    </p>
    ...
    <p style="margin:0; font-size:13px; line-height:1.6; color:#6b7280; text-align:center;">
        Prefer to enter them yourself?
        <a href="{{ config('app.frontend_url', config('app.url')) }}/transactions" style="color:#047844; text-decoration:none;">Log a transaction manually</a>.
    </p>
@endsection

@section('footerNote')
    You're receiving this because inactivity reminders are on.
@endsection
